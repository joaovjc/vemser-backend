...
SELECT c.ID_PESSOA, c.NOME, b.ID_ENDERECO, b.LOGRADOURO FROM PESSOA_X_PESSOA_ENDERECO a RIGHT OUTER JOIN ENDERECO_PESSOA b on a.ID_ENDERECO  = b.ID_ENDERECO RIGHT OUTER join PESSOA  c on a.ID_PESSOA  = c.ID_PESSOA;
